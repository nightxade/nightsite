---
title: Blocked 1
description: "The WOLPHV group (yes, this is an actual article) group encrypted our files, but then blocked us for some reason. I think they might have lost the key. Let's log into their accounts and find it..."
date: 2024-03-19
tags:
  - crypto
order: 10
...
[server.py](/writeups/wolv-ctf-2024/assets/crypto/blocked-1/server.py) 
