---
title: Rivest Shamir Forgot Adleman
description: "Exponents took too long. I decided to use an alternative. It won't about the same right? https://en.wikipedia.org/wiki/RSA(cryptosystem)"
date: 2023-12-04
tags:
  - crypto
order: 4
...
[output.txt](/writeups/newport-blake-ctf-2023/assets/crypto/rsa-output.txt) [chall.py](/writeups/newport-blake-ctf-2023/assets/crypto/rsa-chall.py)  
