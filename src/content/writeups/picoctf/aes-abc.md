---
title: AES Abc
description: "AES-ECB is bad, so I rolled my own cipher block chaining mechanism - Addition Block Chaining! You can find the source here: aes-abc.py. The AES-ABC flag is body.enc.ppm"
date: 2023-07-01
tags:
  - crypto
order: 7
...
AES-ECB is bad, so I rolled my own cipher block chaining mechanism - Addition Block Chaining! You can find the source here: [aes-abc.py](/writeups/picoctf/assets/aes-abc.py). The AES-ABC flag is [body.enc.ppm](/writeups/picoctf/assets/aes-body.enc.ppm)
