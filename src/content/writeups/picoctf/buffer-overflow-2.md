...
description: "Control the return address and arguments This time you'll need to control the arguments to the function you return to! Can you get the flag from this program?"
date: 2023-07-01
tags:
  - pwn
  - buffer-overflow
...
This time you'll need to control the arguments to the function you return to! Can you get the flag from this [program](/writeups/picoctf/assets/bo2-vuln)?  
You can view [source](/writeups/picoctf/assets/bo2-vuln.c) here. And connect with it using `nc saturn.picoctf.net [port #]`
