---
title: Sra
description: "I just recently learnt about the SRA public key cryptosystem... or wait, was it supposed to be RSA? Hmmm, I should probably check... Connect to the program on our server: `nc saturn.picoctf.net [port #]`"
date: 2023-07-01
tags:
  - crypto
  - rsa
...
Download the program: [chal.py](/writeups/picoctf/assets/sra-chal.py)  
