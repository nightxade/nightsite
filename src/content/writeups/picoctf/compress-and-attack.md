---
title: Compress And Attack
description: "Your goal is to find the flag. compress_and_attack.py `nc mercury.picoctf.net [port #]`"
date: 2023-07-01
tags:
  - crypto
order: 11
...
Your goal is to find the flag. [compress_and_attack.py](/writeups/picoctf/assets/compress_and_attack.py) `nc mercury.picoctf.net [port #]`  
