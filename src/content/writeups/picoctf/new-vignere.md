---
title: New Vignere
description: Another slight twist on a classic, see if you can recover the flag. (Wrap with picoCTF{}) `ioffdcjbfjmcifelcaloifgcjecgpgiebpfeiafhgajafkmlfcbpfbioflgcmacg` new_vignere.py
date: 2023-07-01
tags:
  - crypto
  - vigenere
...
Another slight twist on a classic, see if you can recover the flag. (Wrap with picoCTF{}) `ioffdcjbfjmcifelcaloifgcjecgpgiebpfeiafhgajafkmlfcbpfbioflgcmacg` [new_vignere.py](/writeups/picoctf/assets/new_vignere.py)  
