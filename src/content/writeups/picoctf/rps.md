---
title: Rps
description: "Here's a program that plays rock, paper, scissors against you. I hear something good happens if you win 5 times in a row. Connect to the program with netcat: `$ nc saturn.picoctf.net [port #]` The program's source code with the flag redacted can be d"
date: 2023-07-01
tags:
  - pwn
  - strstr
...
The program's source code with the flag redacted can be downloaded [here](/writeups/picoctf/assets/game-redacted.c).  
