...
description: "Do you think you can bypass the protection and get the flag? It looks like Dr. Oswal added a stack canary to this program to protect against buffer overflows. You can view source here. And connect with it using:"
date: 2023-07-01
tags:
  - pwn
order: 3
...
It looks like Dr. Oswal added a stack canary to this [program](/writeups/picoctf/assets/bo3-vuln) to protect against buffer overflows. You can view [source](/writeups/picoctf/assets/bo3-vuln.c) here. And connect with it using:  
