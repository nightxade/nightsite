---
title: X Sixty What
description: "Overflow x64 code Most problems before this are 32-bit x86. Now we'll consider 64-bit x86 which is a little different! Overflow the buffer and change the return address to the flag function in this program. Download source."
date: 2023-07-01
tags:
  - pwn
order: 6
...
Overflow x64 code  
Most problems before this are 32-bit x86. Now we'll consider 64-bit x86 which is a little different! Overflow the buffer and change the return address to the flag function in this [program](/writeups/picoctf/assets/x64vuln). Download [source](/writeups/picoctf/assets/x64vuln.c).  
