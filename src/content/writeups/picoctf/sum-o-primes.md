---
title: Sum O Primes
description: We have so much faith in RSA we give you not just the product of the primes, but their sum as well! - gen.py
date: 2023-07-01
tags:
  - crypto
  - rsa
...
- [gen.py](/writeups/picoctf/assets/sum-o-primes-gen.py)
- [output.txt](/writeups/picoctf/assets/sum-o-primes-output.txt)
